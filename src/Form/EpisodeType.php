    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('number', IntegerType::class, [
                ...
                'invalid_message' => 'Le numéro doit être un nombre entier.',
            ])
            ...
            ->add('spoilerLevel', ChoiceType::class, [
                ...
                'choices' => [
                    'Aucun spoiler' => SpoilerLevel::Aucun,
                    'Spoiler mineur' => SpoilerLevel::Mineur,
                    'Spoiler majeur' => SpoilerLevel::Majeur,
                ],
