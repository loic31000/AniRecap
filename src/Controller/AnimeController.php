...
final class AnimeController extends AbstractController
{
    ...
    public function show(int $id, AnimeRepository $animeRepository, FavoriteRepository $favoriteRepository, CharacterRepository $characterRepository): Response
    {
        $user = $this->getUser();
        ...
        return $this->render('anime/index.html.twig', [
            ...
            'characters' => $characterRepository->findOwnedByAnime($anime, $user),
        ]);
    }
}
