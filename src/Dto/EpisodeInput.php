...
final class EpisodeInput
{
    ...
    #[Assert\NotBlank(message: 'Saisissez le titre de l’épisode.')]
    #[Assert\Length(
        min: 2,
        max: 255,
    ...
    #[Assert\NotNull(message: 'Indiquez le numéro de l’épisode.')]
    ...
    #[Assert\NotBlank(message: 'Saisissez la description de l’épisode.')]
    #[Assert\Length(
        min: 20,
        max: 20_000,
